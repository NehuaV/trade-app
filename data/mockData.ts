import { Game, ItemTemplate, ItemInstance, MarketListing, PricePoint } from '../types';
...
export const GAMES: Game[] = [
  {
    ...
    description: 'The world\'s most popular MOBA with a vast collection of champions.'
  },
  {
    id: 'g2',
    ...
    description: 'A critically acclaimed MMORPG with a rich story and immersive world.'
  },
  {
    id: 'g3',
    name: 'Helldivers 2',
    ...
    description: 'Spread managed democracy across the galaxy in this co-op shooter.'
  },
  {
    id: 'g4',
    ...
    description: 'An open-world MMORPG with intense action combat and stunning graphics.'
  },
  {
    id: 'g5',
    name: 'Genshin Impact',
    ...
    description: 'An open-world action RPG featuring elemental magic and character switching.'
  },
  {
    id: 'g6',
...
const GAME_ASSETS = {
  'g1': { // LoL
    prefixes: ['Crystal', 'Infernal', 'Project', 'Star Guardian', 'Blood Moon', 'High Noon', 'Pool Party', 'Arcade', 'Dark Star', 'Spirit Blossom', 'Sentinel', 'Ruined', 'Battle Academia', 'Odyssey', 'Winterblessed', 'Coven'],
    nouns: ['Lux', 'Ahri', 'Yasuo', 'Zed', 'Jinx', 'Thresh', 'Ezreal', 'Lee Sin', 'Akali', 'Vayne', 'Riven', 'Kai\'Sa', 'Teemo', 'Yone', 'Irelia', 'Sett'],
    rarities: ['Common', 'Uncommon', 'Rare', 'Mythical', 'Legendary']
  },
  'g2': { // FF14
    prefixes: ['Heavy', 'Light', 'Dark', 'Ancient', 'Allagan', 'Chocobo', 'Moogle', 'Bahamut', 'Shiva', 'Ifrit', 'Garlean', 'Eorzean', 'Ishgardian', 'Ala Mhigan', 'Doman', 'Crystal'],
    nouns: ['Coat', 'Helm', 'Boots', 'Gloves', 'Sword', 'Staff', 'Grimoire', 'Whistle', 'Mount', 'Barding', 'Minion', 'Crystal', 'Earrings', 'Necklace', 'Ring'],
    rarities: ['Common', 'Uncommon', 'Rare', 'Legendary', 'Ancient']
  },
  'g3': { // Helldivers 2
    prefixes: ['Tactical', 'Heavy', 'Light', 'Scout', 'Medic', 'Engineer', 'Democracy', 'Freedom', 'Liberty', 'Veteran', 'Heroic', 'Super Earth', 'Automaton', 'Terminid', 'Orbital'],
    nouns: ['Cape', 'Helmet', 'Armor', 'Vest', 'Boots', 'Insignia', 'Badge', 'Rifle', 'Shotgun', 'Pistol', 'Grenade', 'Stim'],
    rarities: ['Common', 'Uncommon', 'Rare', 'Legendary']
  },
  'g4': { // BDO
    prefixes: ['Blackstar', 'Kzarka', 'Dandelion', 'Nouver', 'Kutum', 'Dim Tree', 'Griffon', 'Urugon', 'Bheg', 'Leebur', 'Muskan', 'Oogway', 'Tuvala', 'Naru'],
    nouns: ['Longsword', 'Bow', 'Axe', 'Staff', 'Blade', 'Gauntlet', 'Vambrace', 'Kriegsmesser', 'Cestus', 'Scythe', 'Greatsword', 'Lancia', 'Shortsword'],
    rarities: ['Rare', 'Mythical', 'Legendary', 'Ancient']
  },
  'g5': { // Genshin
    prefixes: ['Favonius', 'Sacrificial', 'Royal', 'Blackcliff', 'Prototype', 'Iron Sting', 'Whiteblind', 'Mappa Mare', 'Crescent', 'Compound', 'Skyward', 'Amos', 'Wolf\'s', 'Lost Prayer'],
    nouns: ['Sword', 'Claymore', 'Polearm', 'Bow', 'Catalyst', 'Wing Glider', 'Namecard', 'Outfit', 'Vision', 'Sigil'],
    rarities: ['Common', 'Uncommon', 'Rare', 'Mythical', 'Legendary']
  },
  'g6': { // Indie
    prefixes: ['Quantum', 'Plasma', 'Laser', 'Void', 'Nebula', 'Galactic', 'Stellar', 'Cosmic', 'Hyper', 'Warp', 'Dark Matter', 'Antimatter', 'Photon', 'Ion'],
    nouns: ['Engine', 'Thruster', 'Shield', 'Cannon', 'Reactor', 'Hull', 'Sensor', 'Scanner', 'Droid', 'Module', 'Capacitor', 'Battery', 'Antenna'],
...
const generateGameItems = () => {
  ...
  GAMES.forEach(game => {
    ...
    for (let i = 0; i < needed; i++) {
        ...
        const prefix = assets.prefixes[Math.floor(Math.random() * assets.prefixes.length)];
        const noun = assets.nouns[Math.floor(Math.random() * assets.nouns.length)];
        const rarity = assets.rarities[Math.floor(Math.random() * assets.rarities.length)] as any;
        ...
        const basePrice = Math.floor(Math.random() * 150) + 5 + (rarity === 'Ancient' ? 200 : 0);
